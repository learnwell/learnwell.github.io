...
1. Google Classroom
	...
	* Has an app for the iPad
		...
		* `Stream` like structure for emphasizing latest content and a `Classwork` area for organized content. Introductory [howto](https://www.youtube.com/watch?v=M6L-nZGIUTE) videos shared by the community are useful for getting started.
2. Moodle
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU3MDQ3MjEwOCwtMjA3NjgyNTEwMiwxOT
