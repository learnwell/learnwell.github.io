...
1. Google Classroom
	...
	* Has an app for the iPad
		...
		* `Stream` like structure for content and a `Classwork` area for organizing content. Introductory [howto](https://www.youtube.com/watch?v=M6L-nZGIUTE) videos shared by the community are useful for getting started.
2. Moodle
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MTQ1MDE4NSwtMjA3NjgyNTEwMiwxOT
