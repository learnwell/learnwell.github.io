...
* Luckily there is a way to create handwritten notes directly on anki when using an iPad using apple pencil. I type my question so that I still have the benefit of searching 
* Make 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE1ODI4MTAzMV19
-->